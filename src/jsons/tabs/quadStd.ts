...
export const quadStd: TabWithItems = {
	...
	items: [
		...
		{
			baseType: 'Leather Belt',
			explicitMods: [{ description: '+47 to Intelligence' }, { description: '32% increased Stun Duration on Enemies' }, { description: 'Reflects 1 Physical Damage to Melee Attackers' },
			],
			fractured: true,
			...
			identified: true,
			ilvl: 83,
			implicitMods: [{ description: '+30 to maximum Life' }],
			inventoryId: 'Stash1',
			league: 'Standard',
			name: 'Death Buckle',
			rarity: 'Rare',
